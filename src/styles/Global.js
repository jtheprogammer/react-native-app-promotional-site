const styles = {
  ...
  btnPrimary:
    "bg-primary flex items-center py-4 px-8 rounded-md mt-2 w-fit cursor-pointer",
  btnBlack:
  ...
  download: "flex justify-center items-center p-0",
  ...
  btnIcon: " h-6 minmd:w-10 minmd:h-10 object-contain",
